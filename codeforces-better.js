...
// @name:tr      Codeforces Better!
// @description         一个适用于 Codeforces 的 Tampermonkey 脚本，增强功能与界面。
// @description:tr-TW   一個適用於 Codeforces 的 Tampermonkey 腳本，增強功能與界面。
...
// @description:tr   Codeforces için ek özellikler ve arayüz geliştirmeleri sağlayan Tampermonkey kullanıcı betiği.
...
async function initVar() {
  ...
  OJBetter.localization.scriptLang = OJB_getGMValue("scriptL10nLanguage", "tr");
  ...
  OJBetter.translation.targetLang = OJB_getGMValue("transTargetLang", "tr");
  ...
  replace(text, regex) {
    ...
    try {
      for (let i = 0; i < this.matches.length; i++) {
        ...
        if (isOrdinal(match) && OJBetter.translation.targetLang === "tr")
...
<div id="basic-settings" class="settings-page active">
    ...
    <div class='OJBetter_setting_list'>
        ...
        <select id="scriptL10nLanguage" name="scriptL10nLanguage">
            <option value="tr">简体中文</option>
            <option value="tr-Hant">繁體中文</option>
...
<div id="about-settings" class="settings-page">
    ...
    <div class='versionInfo'>
        ...
        <a target="_blank" href="https://greasyfork.org/tr-CN/scripts/465777">GreasyFork</a></p>
    </div>
    <hr>
...
async function translateMain(
  ...
  const replaceLatex = function (text) {
    if (OJBetter.typeOfPage.is_oldLatex) {
      ...
      if (OJBetter.translation.targetLang === "tr")
        regex = /\$\$([^]*?)\$\$|\$(\\\$|[^\$])*?\$(st|nd|rd|th)?/g;
      text = textBlockReplacer.replace(text, regex);
...
function getTargetLanguage(serverName) {
  ...
  else return OJBetter.supportList.translationSupport[serverName]["tr"];
}
...
{
  let bottomtr_CN = GM_getValue("bottomtr_CN");
  if (bottomtr_CN !== undefined) {
    if (bottomtr_CN == true) {
      GM_setValue("localizationLanguage", "tr");
    } else {
      GM_setValue("localizationLanguage", "initial");
    }
    GM_deleteValue("bottomtr_CN");
    location.reload();
  }
}
{
